...
export default function Contact() {
  ...
  const socialLinks = [
    ...
    {
      name: 'Email',
      url: portfolioConfig.social.email,
      icon: (
          ...
          <div className="animate-slide-up">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              ...
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-400">{portfolioConfig.contact.location}</p>
              </div>
              ...
              <div className="bg-gray-800/30 rounded-xl p-6">
                ...
                <p className="text-gray-400">Within {portfolioConfig.contact.responseTime}</p>
              </div>
            </div>
            ...
            <div className="animate-slide-up" style={{animationDelay: '0.2s'}}>
              ...
              <div className="flex justify-center space-x-6">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="group flex flex-col items-center p-4 bg-gray-800/30 rounded-xl hover:bg-gray-700/50 transition-all duration-300 hover:scale-105"
                  >
                    <div className="w-12 h-12 bg-gray-700/50 rounded-lg flex items-center justify-center text-gray-400 group-hover:text-white group-hover:bg-gradient-to-r group-hover:from-blue-500/20 group-hover:to-purple-500/20 transition-all duration-300 mb-2">
                      {link.icon}
                    </div>
              ...
              <p className="text-gray-400 mt-8">
                Click on any platform above to reach out directly!
              </p>
            </div>
          </div>
        </div>
